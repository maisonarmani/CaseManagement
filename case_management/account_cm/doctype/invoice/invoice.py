...
class Invoice(SellingController):
	def __init__(self, arg1, arg2=None):
		super(Invoice, self).__init__(arg1, arg2)
		self.status_updater = [{
	...
	def set_missing_values(self, for_validate=False):
		...
		super(Invoice, self).set_missing_values(for_validate)
	...
	def validate_with_previous_doc(self):
		super(Invoice, self).validate_with_previous_doc({
			"Sales Order": {
	...
	def validate_warehouse(self):
		super(Invoice, self).validate_warehouse()
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and \
			...
			gl_entries += super(Invoice, self).get_gl_entries()
...
def make_delivery_note(source_name, target_doc=None):
	...
	doclist = get_mapped_doc("Invoice", source_name, 	{
		"Invoice": {
...
def make_sales_return(source_name, target_doc=None):
	...
	return make_return_doc("Invoice", source_name, target_doc)
